...
export default function EditBanner() {
  ...
  if (fetching) {
    return (
      <div className="max-w-[1000px] mx-auto p-12 text-center text-sm font-semibold text-slate-400 dark:text-slate-500 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-2xl transition-colors">
  ...
  return (
    <div className="max-w-[1000px] mx-auto space-y-6 pb-12 px-4 sm:px-0">
      ...
      <div className="flex items-center gap-4 bg-white dark:bg-slate-900 p-6 rounded-2xl border border-[#e2e8f0] dark:border-slate-800 shadow-sm transition-colors">
        ...
        <div>
          <h1 className="text-xl font-bold text-[#0f172a] dark:text-slate-100 tracking-tight">Edit Hero Slider Banner</h1>
          <p className="text-xs text-[#64748b] dark:text-slate-400 mt-0.5">Modify text parameters, replace hero showcase banners graphics, and tweak interactive routing routes.</p>
        </div>
      </div>
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-[#e2e8f0] dark:border-slate-800 shadow-sm space-y-4 transition-colors">
            ...
            <div className="space-y-3">
              {imagePreview ? (
                ...
                <label className="flex flex-col items-center justify-center w-full aspect-square border-2 border-dashed border-slate-200 dark:border-slate-700 hover:border-indigo-400 dark:hover:border-indigo-400 bg-[#f8fafc] dark:bg-slate-800/40 rounded-xl cursor-pointer p-4 text-center transition-colors">
                  <div className="p-3 bg-white dark:bg-slate-800 rounded-xl border border-slate-100 dark:border-slate-700 shadow-xs text-slate-400 dark:text-slate-500">
                    <Image size={24} />
                  </div>
                  <input type="file" accept="image/*" onChange={handleImageChange} className="hidden" />
                </label>
          ...
          <div className="bg-white dark:bg-slate-900 p-6 rounded-2xl border border-[#e2e8f0] dark:border-slate-800 shadow-sm space-y-4 transition-colors">
            ...
            <div className="flex items-center justify-between p-2.5 bg-slate-50 dark:bg-slate-800/60 border border-slate-100 dark:border-slate-800 rounded-xl">
              <div className="flex flex-col">
                <span className="text-xs font-bold text-slate-700 dark:text-slate-200">Active Slide State</span>
                <span className="text-[10px] text-slate-400 dark:text-slate-500">Present inside carousel line</span>
              </div>
