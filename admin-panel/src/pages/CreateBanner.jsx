  ...
  return (
    <div className="max-w-[1000px] mx-auto space-y-6 pb-12 px-4 sm:px-0">
      ...
      <div className="flex items-center gap-4 bg-white p-6 rounded-2xl border border-[#e2e8f0] shadow-sm">
        ...
        <div>
          <h1 className="text-xl font-bold text-[#0f172a] tracking-tight">Create Hero Slider Banner</h1>
          <p className="text-xs text-[#64748b] mt-0.5">Configure copy headings, actions links, image parameters, and home stats showcases.</p>
        </div>
      </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-[#e2e8f0] shadow-sm space-y-4">
            ...
            <div className="space-y-1.5">
              ...
              <input
                ...
                className="w-full bg-[#f8fafc] border border-[#e2e8f0] rounded-xl px-3 py-2.5 outline-none text-sm font-semibold text-amber-700 placeholder-slate-400 focus:border-indigo-500"
              />
            </div>
            ...
            <div className="space-y-1.5">
              ...
              <textarea
                ...
                onChange={handleInputChange}
                className="w-full bg-[#f8fafc] border border-[#e2e8f0] rounded-xl px-3 py-2.5 outline-none text-base font-extrabold tracking-tight text-slate-800 focus:border-indigo-500 uppercase placeholder:normal-case"
              />
            </div>
              ...
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-xl space-y-3">
                <div className="space-y-1">
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full bg-white border border-slate-200 rounded-lg px-2.5 py-1.5 outline-none text-sm font-black text-slate-880 focus:border-indigo-500"
                  />
                </div>
                <div className="space-y-1">
          ...
          <div className="bg-white p-6 rounded-2xl border border-[#e2e8f0] shadow-sm space-y-4">
            ...
            <div className="space-y-3">
              {imagePreview ? (
                ...
                <label className="flex flex-col items-center justify-center w-full aspect-square border-2 border-dashed border-slate-200 hover:border-indigo-400 bg-[#f8fafc] rounded-xl cursor-pointer transition-colors group p-4 text-center">
                  <div className="p-3 bg-white rounded-xl border border-slate-100 shadow-xs text-slate-400 group-hover:text-indigo-500 transition-colors">
                    <Image size={24} />
                  </div>
                  <span className="text-xs font-bold text-slate-700 mt-3 block">Upload Banner Image</span>
                  <span className="text-[10px] font-medium text-slate-400 mt-1 block">Supports Transparent PNGs, WebP or JPEGs</span>
                  <input type="file" accept="image/*" onChange={handleImageChange} className="hidden" />
                </label>
              )}
            </div>
          ...
          <div className="bg-white p-6 rounded-2xl border border-[#e2e8f0] shadow-sm space-y-4">
            ...
            <div className="flex items-center justify-between p-2.5 bg-slate-50 border border-slate-100 rounded-xl">
              <div className="flex flex-col">
                ...
                <span className="text-[10px] text-slate-400">Make active in hero pipeline carousel</span>
              </div>
