...
import { uploadDesignImage, uploadBase64Image, getMyUploads, deleteMyUpload, proxyImage } from '../controllers/uploadController.js';
...
router.post('/base64', optionalProtect, uploadBase64Image);
