...
export const placeOrderRules = [
  ...
  body('shippingAddress.phone').notEmpty().withMessage('Shipping phone is required').trim(),
  ...
  body('billingAddress.phone').notEmpty().withMessage('Billing phone is required').trim(),
